...
$values = array(
    ...
    "rice flakes", "muesli", "popcorn", "pasta", "macaroni", "noodles", "spaghetti", "vermicelli", "ravioli", "dumplings", "flour", "dough", "batter",
    "cake mix", "bread",
...
if(isset($_POST['add'])) {
    ...
    <?php
            try {
                ...
                $qryStr = " INSERT INTO `products` (`marketName`, `productName`, `quantity`, `price`, `manufacturing`, `expiryDate`, `productNumber`, `amount`,`image`) VALUES ('" . $var . "', '" . $name . "', '" . $quantity . "', '" . $price . "', '" . $manufacturing . "', '" . $expiryDate . "', '" . $productNum ."', '" . $amount . "','$file'  ) ";
                $db->query($qryStr);
                $db->commit();
                $db->close();
