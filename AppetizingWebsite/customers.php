...
function button1()
{
    ...
    try {
        ...
        $sql = "DELETE FROM test WHERE signin= '$var'";
  ...
  <div class="container d-flex justify-content-between align-items-center">
    ...
    <div class="logo">
      ...
      <nav id="navbar" class="navbar">
          ...
          <form method="post">
              <input  type="submit" id="button1"  value="Sign Out " name="button1" class="active " style="background-color:rgba(109, 161, 75,0);color: white;font-weight: bold;border: none;margin-left: 6px;font-size: 13px">
          </form>
      </nav><!-- .navbar -->
  </div>
</header><!-- End Header -->
